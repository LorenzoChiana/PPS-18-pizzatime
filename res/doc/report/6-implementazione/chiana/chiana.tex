%In questo progetto ho contribuito a:
%\begin{itemize}
%	\item gameview:
%		\begin{itemize}
%			\item Window (primo sprint)
%			\item fx:
%				\begin{itemize}
%					\item FXCreditsScene (primo sprint)
%					\item FXGameScene (tutti gli sprint)
%					\item FXMainScene (primo sprint)
%					\item FXPlayerRankingsScene (quarto sprint)
%					\item FXSettingsScene (primo e quarto sprint)
%					\item FXView (primo sprint)
%					\item FXWindow (primo sprint)
%				\end{itemize}
%			\item scene:
%				\begin{itemize}
%					\item Scene (primo sprint)
%					\item SceneType (primo sprint)
%				\end{itemize}
%		\end{itemize}
%	\item gamelogic:
%		\begin{itemize}
%			\item Arena (secondo sprint)
%			\item Collectible
%			\item 
%		\end{itemize}
%\end{itemize}
...
Dopo le varie rifattorizzazioni susseguite nei vari sprint del mio contributo più significativo rimane:
\begin{itemize}
